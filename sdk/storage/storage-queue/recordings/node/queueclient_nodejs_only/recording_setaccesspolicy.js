...
module.exports.testInfo = {"queue":"queue156323825246902344"}

nock('https://fakestorageaccount.queue.core.windows.net:443', {"encodedQueryParams":true})
  .put('/queue156323825246902344')
  .query(true)
  ...
  'x-ms-request-id',
  'c4a0f6ab-e003-00e8-0c70-3b876a000000',
  'x-ms-version',
  '2018-03-28',
  'Date',
...
nock('https://fakestorageaccount.queue.core.windows.net:443', {"encodedQueryParams":true})
  ...
  'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id',
  'b70ce2d3-f003-0019-1070-3b56f9000000',
  'x-ms-version',
  '2018-03-28',
  'Date',
  'Tue, 16 Jul 2019 00:50:52 GMT',
  'Connection',
  'close' ]);


nock('https://fakestorageaccount.queue.core.windows.net:443', {"encodedQueryParams":true})
  .get('/queue156323825246902344')
  .query(true)
  ...
  'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id',
  '189168a8-b003-00b4-3a70-3b7693000000',
  'x-ms-version',
  '2018-03-28',
...
nock('https://fakestorageaccount.queue.core.windows.net:443', {"encodedQueryParams":true})
  .delete('/queue156323825246902344')
  .query(true)
  .reply(204, "", [ 'Content-Length',
  '0',
  'Server',
  'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id',
  '75cf4ccb-8003-001d-2d70-3ba37b000000',
  'x-ms-version',
  '2018-03-28',
  'Date',
  'Tue, 16 Jul 2019 00:50:53 GMT',
